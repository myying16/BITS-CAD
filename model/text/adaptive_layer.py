...
from model.layers.functional import FeedForwardLayer
from rich import print
from model.text.utils_decode import generate_attention_mask
from model.text.utils import count_parameters
...
class TextAdaptiveLayer(nn.Module):
    ...
    def forward(
        ...
        #print("T", T2.shape)    #[256, 71, 1024]
        T2 = T2.permute(1, 0, 2).contiguous()
        #print("T2", T2.shape)    #[71, 256, 1024]
        # exit()
...
if __name__ == "__main__":
    ...
    print("attn_weight",output.shape)
    print("adaptive_layer.total_parameters()",adaptive_layer.total_parameters())
