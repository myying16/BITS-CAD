...
class TextEmbedder(nn.Module):
    def __init__(self, model_name: str, cache_dir: str, max_seq_len: int):
        ...
        self.tokenizer = BertTokenizer.from_pretrained(pretrained_model_name_or_path=cache_dir)
        ...
        self.model = BertModel.from_pretrained(pretrained_model_name_or_path=cache_dir,
                                               max_position_embeddings=max_seq_len).to(device)
        print("Model loaded")
    ...
    def get_embedding(self, texts: list[str]):
        ...
        with torch.no_grad():
            ...
            embedding = all_output[0]   #(B, L, 1024)
